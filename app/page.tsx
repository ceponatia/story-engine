  ...
  const features = [
    {
      ...
      description: "Build detailed characters with rich backgrounds, personalities, and relationships.",
      color: "bg-blue-500"
    },
    {
      icon: MapPin,
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              The ultimate platform for creating, managing, and telling interactive stories. 
              Build rich characters, immersive worlds, and compelling narratives with the power of AI.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Everything you need to create, organize, and share your stories in one integrated platform.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <Card key={index} className="hover:shadow-lg transition-all duration-300 border-0 bg-background/60 backdrop-blur">
