      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (<Card key={index} className="hover:shadow-lg transition-all duration-300 border-0 bg-background/60 backdrop-blur">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {loggedIn && (<Button size="lg" asChild>
                <Link href="/library/characters" className="flex items-center gap-2">
