...
import { getTablesInfo, getTableData, TableInfo, TableData } from "@/lib/actions/admin";
// Removed unused Sidebar component imports
...
export function DatabaseAdmin() {
  ...
  return (
    <>
      ...
      {/* Fixed Main Content - positioned absolutely */}
