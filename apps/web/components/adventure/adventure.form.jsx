...
export function NewAdventureForm({ characters, locations, settings }) {
      ...
      <CardContent>
        <form action={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <Input id="title" name="title" placeholder="Enter a title for your adventure" required/>
          </div>

          <div className="space-y-2">
            <Label htmlFor="name">Your Name</Label>
            <Input id="name" name="name" placeholder="Enter your name (how the character will refer to you)" required/>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select name="characterId" required>
              ...
              <SelectContent>
                {characters.map((character) => (<SelectItem key={character.id} value={character.id}>
          ...
          {locations.length > 0 && (<div className="space-y-2">
          ...
          {settings.length > 0 && (<div className="space-y-2">
              ...
              <Select name="settingId">
                ...
                <SelectContent>
                  <SelectItem value="none">None</SelectItem>
                  {settings.map((setting) => (<SelectItem key={setting.id} value={setting.id}>
                      {setting.name}
                    </SelectItem>))}
                </SelectContent>
              </Select>
          ...
          <div className="space-y-2">
            ...
            <Textarea id="initialMessage" name="initialMessage" placeholder="Enter the character's opening message to start the adventure..." rows={3} required/>
