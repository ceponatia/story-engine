...
export function AdventuresList({ adventures }) {
    ...
    return (<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      {adventures.map((adventure) => {
            var _a;
            return (<Card key={adventure.id} className="hover:shadow-lg transition-shadow">
          <CardHeader>
            <CardTitle>{adventure.title}</CardTitle>
            <CardDescription>
              Playing as {(_a = adventure.characters) === null || _a === void 0 ? void 0 : _a.name}
