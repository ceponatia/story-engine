...
export function AdventureTypeView({ adventureType }) {
    ...
    return (<div className="space-y-6">
        ...
        <CardHeader>
          <div className="flex items-start justify-between">
            <div>
              ...
              {adventureType.description && (<CardDescription className="mt-2">{adventureType.description}</CardDescription>)}
            </div>
            <div className="flex items-center gap-2">
              {adventureType.is_public ? (<Badge variant="secondary">
              ...
              {isOwner && (<div className="flex gap-2">
                  ...
                  <Button variant="outline" size="sm" onClick={() => setShowDeleteConfirm(true)} disabled={loading}>
          ...
          <Tabs defaultValue="template" className="w-full">
            ...
            <TabsContent value="template" className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Button variant="outline" size="sm" onClick={() => copyToClipboard(adventureType.template_content)}>
                    <Copy className="h-4 w-4 mr-1"/>
                    Copy
                  </Button>
                </div>
                <Textarea value={adventureType.template_content} readOnly rows={15} className="font-mono text-sm"/>
              </div>
            </TabsContent>
            ...
            <TabsContent value="config" className="space-y-4">
              <div>
                ...
                <Textarea value={JSON.stringify(adventureType.validation_config, null, 2)} readOnly rows={10} className="font-mono text-sm"/>
              </div>
            </TabsContent>
          </Tabs>
        </CardContent>
      ...
      {showDeleteConfirm && (<Card className="border-destructive">
          <CardHeader>
