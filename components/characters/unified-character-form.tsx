...
export function UnifiedCharacterForm({ 
  ...
  const extractAttributeText = (attributeData: any) => {
    ...
    try {
      ...
      return typeof attributeData === 'object' ? JSON.stringify(attributeData) : String(attributeData);
    }
  };
    ...
    <form id="character-form" onSubmit={handleSubmit} className="space-y-4 p-4 max-w-2xl mx-auto">
      ...
      <div className="grid gap-2">
        ...
        <Input
          ...
          readOnly={!isFormMode}
          required={isFormMode}
          className={cn(validationErrors.includes("name") && "border-red-500 focus-visible:ring-red-500")}
        />
      </div>
      ...
      <div className="grid gap-2">
        ...
        <Input
          ...
          readOnly={!isFormMode}
          required={isFormMode}
          className={cn(validationErrors.includes("age") && "border-red-500 focus-visible:ring-red-500")}
        />
      </div>
      ...
      <div className="grid gap-2">
        ...
        <Textarea
          ...
          readOnly={!isFormMode}
          required={isFormMode}
          className={cn(validationErrors.includes("appearance") && "border-red-500 focus-visible:ring-red-500")}
        />
      </div>
      ...
      <div className="grid gap-2">
        ...
        <Textarea
          ...
          readOnly={!isFormMode}
          required={isFormMode}
          className={cn(validationErrors.includes("personality") && "border-red-500 focus-visible:ring-red-500")}
        />
      </div>
      ...
      <div className="grid gap-2">
        ...
        <Textarea
          ...
          readOnly={!isFormMode}
          required={isFormMode}
          className={cn(validationErrors.includes("background") && "border-red-500 focus-visible:ring-red-500")}
        />
      </div>
      ...
      <AlertDialog open={showValidationModal} onOpenChange={setShowValidationModal}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Please fill out the highlighted fields. The following fields are required: Name, Age, Gender, Appearance, Personality, and Background.
            </AlertDialogDescription>
          </AlertDialogHeader>
