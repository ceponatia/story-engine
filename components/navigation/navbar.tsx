...
import { BookOpen, Users, MapPin, Sparkles, User, Menu, Play, Plus } from "lucide-react";
// TODO: Replace with proper user type after database integration
interface User {
  id: string;
  email?: string;
}
        ...
        <NavigationMenu>
          <NavigationMenuList>
            ...
            <NavigationMenuItem>
              <NavigationMenuTrigger
                className={cn(
                  pathname.startsWith("/adventures") && "bg-accent text-accent-foreground"
                )}
              >
                Adventures
              </NavigationMenuTrigger>
            ...
            <NavigationMenuItem>
              <NavigationMenuTrigger
                className={cn(
                  pathname.startsWith("/library") && "bg-accent text-accent-foreground"
                )}
              >
                Library
              </NavigationMenuTrigger>
