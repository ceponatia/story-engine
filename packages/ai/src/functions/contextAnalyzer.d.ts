...
export interface ConversationContext {
    ...
    activeAdventureCharacterId?: string;
    adventureId: string;
...
export declare function analyzeConversationContext(context: ConversationContext, options?: {
    lookbackMessages?: number;
    confidenceThreshold?: number;
    enableEmbeddingSimilarity?: boolean;
}): Promise<ContextAnalysisResult>;
export declare function executeAttributeQueries(queries: AttributeQuery[]): Promise<Record<string, unknown>>;
export declare function getContextualCharacterInfo(context: ConversationContext, options?: {
    lookbackMessages?: number;
    confidenceThreshold?: number;
    enableEmbeddingSimilarity?: boolean;
}): Promise<{
