...
export declare function extractStateFromResponse(responseText: string, adventureId: string, options?: {
...
export declare function getExtractionConfig(mode: "conservative" | "balanced" | "aggressive"): Partial<StateExtractionConfig["enabledFeatures"]>;
