 ...
 *
 * @param {string} envPath - Path to environment file (default: ".env.local")
 * @param {object} options - Additional dotenv configuration options
 */
function loadEnv(envPath = ".env.local", options = {}) {
  const config = {
    path: envPath,
    ...options,
  };
 ...
 * @param {string} envPath - Path to environment file (default: ".env.local")
 */
function loadEnvForScript(envPath = ".env.local") {
