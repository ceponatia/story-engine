import type { ConversationMessage, SearchResult, SearchOptions, TextMatchOptions } from "../../types/search";
...
export declare function searchConversationMessages(query: string, messages: readonly ConversationMessage[], options?: ConversationSearchOptions & TextMatchOptions): readonly ConversationMatch[];
export declare function conversationMatchesToSearchResults(matches: readonly ConversationMatch[], options?: {
    contentTruncateLength?: number;
    includeContext?: boolean;
}): readonly SearchResult[];
export declare function groupConversationsByContext(messages: readonly ConversationMessage[], options?: {
    maxGroupSize?: number;
