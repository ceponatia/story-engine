import type { TextMatchOptions } from "@story-engine/types";
...
export declare function calculateKeywordSimilarity(
  query: string,
  content: string,
...
export declare function extractBestMatches(
  query: string,
  content: string,
  options?: {
    maxSegments?: number;
...
export declare function combineSimilarityScores(
  scores: Array<{
    score: number;
    weight: number;
  }>
