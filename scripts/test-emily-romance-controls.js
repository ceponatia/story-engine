...
try {
  ...
  const hasUserProtection = romancePrompt.includes('NEVER write dialogue, actions, or thoughts for Alex')
...
testResponses.forEach((test, index) => {
  ...
  const hasMissingAsterisks = /\b(She|He|I)\s+(walked|ran|looked|felt|thought|moved|stepped)\b/g.test(test.content) && 
